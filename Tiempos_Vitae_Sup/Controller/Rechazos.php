 ...
 if(isset($_POST['guardar'])){
   ...
   if($es == 'setup'){
    ...
    if($motivo1 == 5){  //Selección de la opción liberación, se abre el campo de inspector
      try{
        $tipo = 'setup1';
        $params = array(':p1' => $tipo,':p2' => $sucursal, ':p3' => $area,':p4' => $producto,':p5' => $lote,':p6' => $ot,
                        ':p7' => $lider,':p8' => $supervisor,':p9' => $turno, ':p10' => $es, 
      ...
      try{
        $tipo = 'setup1';
        $params = array(':p1' => $tipo,':p2' => $sucursal, ':p3' => $area,':p4' => $producto,':p5' => $lote,
                        ':p6' => $ot,':p7' => $lider,':p8' => $supervisor,':p9' => $turno, ':p10' => $es, 
