...
<header>
 ...
 <div class="logo">
    ...
    <button href = "../View/HxH.php" class="boton BotonAdmin" id="boton1">Operador</button>
    <button href = "../View/Supervisor.php" class="boton BotonAdmin" id="boton2">Supervisor</button>
    <button href = "../View/Reporte.php" class="boton BotonAdmin" id="boton3">Reporte</button>
 </div>
 <script>
        document.getElementById("boton1").addEventListener("click", function() {
            window.location.href = "../View/HxH.php";
        });

        document.getElementById("boton2").addEventListener("click", function() {
            window.location.href = "../View/Supervisor.php";
        });
